...
public class SaveTeacherWithExistingPrincipalController {

	public static void main(String[] args) {
		TeacherPrincipalService teacherPrincipalService=new TeacherPrincipalService();
		
		Teacher teacher = new Teacher(18, "raju", "raju@gmail.com", 54984318, 5);
//		Principal principal = new Principal(12, "rjendra", "reaje@gmail.com", 646484846, 626565, 10);
		teacherPrincipalService.saveTeacherWithExistingPrincipalService(teacher, 13);
	}
